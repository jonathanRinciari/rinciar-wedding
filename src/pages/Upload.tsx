        ...
        <Card sx={{ minWidth: 275 }}>
          <CardContent>
            ...
            <Typography variant="body2" textAlign='center'>
               Please upload photos of memories with Emine+Jon, moments from the wedding day or anything
                that reminds you of the couple. All of these photos will be displayed at the wedding.
            </Typography>
          </CardContent>
          {
            loading ? (
